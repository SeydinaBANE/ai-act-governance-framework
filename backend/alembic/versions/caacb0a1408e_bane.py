...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("ADMIN", "REVIEWER", "READONLY", name="userrole"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum("PROHIBITED", "HIGH_RISK", "LIMITED_RISK", "MINIMAL_RISK", name="riskcategory"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "PUBLISHED", "ARCHIVED", name="modelcardstatus"),
            nullable=False,
        ),
        sa.Column("created_by", sa.UUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type",
            sa.Enum("FILE", "TEXT", "DATABASE_SAMPLE", name="scansourcetype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "risk_level",
            sa.Enum("CRITICAL", "HIGH", "MEDIUM", "LOW", "NONE", name="piiscanrisklevel"),
            nullable=True,
        ),
